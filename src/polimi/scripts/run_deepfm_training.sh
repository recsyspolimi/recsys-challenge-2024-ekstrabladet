python ~/RecSysChallenge2024/src/polimi/scripts/deepfm_training.py \
    ...
    -early_stopping_path /home/ubuntu/experiments/early_stopping_ds \
    -numerical_transformer_es /mnt/ebs_volume/experiments/subsample_train_new_yeo_johnson_fit/numerical_transformer.joblib \
